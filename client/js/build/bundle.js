...
var _componentsSearchresultJs = require('./components/searchresult.js');
...
var addRoomToCookie = function addRoomToCookie(room) {
	var now = new Date();
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							...
							_react2["default"].createElement(
								"button",
								{ className: "pure-button", onClick: this.clicked.bind(this) },
								"Request"
							)
						)
					)
