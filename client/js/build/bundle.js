...
var _componentsSonginfoJs = require('./components/songinfo.js');
...
exports.SampleTrack = SampleTrack;
...
var SongInfo = (function (_Component) {
	_inherits(SongInfo, _Component);

	function SongInfo(props) {
		_classCallCheck(this, SongInfo);

		_get(Object.getPrototypeOf(SongInfo.prototype), "constructor", this).call(this, props);
		this.state = {
			show: true
		};
	}
