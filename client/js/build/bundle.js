...
var _componentsSearchbarJs = require('./components/searchbar.js');

var _componentsTestcomponentJs = require('./components/testcomponent.js');

var toTest = _react2['default'].createElement(
	'div',
	null,
	_react2['default'].createElement(_componentsSearchbarJs.SearchBar, null),
	_react2['default'].createElement(_componentsTestcomponentJs.TestComp, null)
);

_react2['default'].render(toTest, document.getElementById('content'));

},{"./components/searchbar.js":2,"./components/testcomponent.js":3,"react":159}],2:[function(require,module,exports){
"use strict";
...
var TestComp = (function (_Component) {
  ...
  function TestComp() {
    ...
    _get(Object.getPrototypeOf(TestComp.prototype), 'constructor', this).apply(this, arguments);
  }
